...
@media(max-width:900px){
  ...
  .builder-select-grid{grid-template-columns:1fr}
  .design-grid{grid-template-columns:1fr}
}
@media(max-width:640px){
  #map{height:50vh}
  .map-entry-btns{flex-direction:column;gap:8px;align-items:center}
  .top-bar{padding:0 14px}
  .breadcrumb-bar{padding:8px 14px}
  .view-content{padding:14px}
  .continue-footer{padding:14px}
  .eoi-section{margin:0 14px 14px}
